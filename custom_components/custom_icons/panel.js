...
__decorate([
    i$1("#download-button")
], CustomIconsDownloadCard.prototype, "download_button", void 0);
...
let CustomIconsIcon = class CustomIconsIcon extends s {
    render() {
        return o(renderIconHTML(this.icon));
    }
};
__decorate([
    n$1()
], CustomIconsIcon.prototype, "icon", void 0);
CustomIconsIcon = __decorate([
    e$3("custom-icons-icon")
], CustomIconsIcon);
